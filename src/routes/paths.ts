...
export const paths = {
  ...
  auth: {
    ...
    // Rutas de autenticación híbrida (Auth0 + Custom Backend)
    signIn: `${ROOTS.AUTH}/sign-in`, // Punto de entrada - validación de email
    signInPassword: `${ROOTS.AUTH}/sign-in/password`, // Login con contraseña
    signInSocial: `${ROOTS.AUTH}/sign-in/social`, // Login social con Auth0
    signUp: `${ROOTS.AUTH}/sign-up`, // Registro
    resetPassword: `${ROOTS.AUTH}/reset-password`, // Solicitar reset
    updatePassword: `${ROOTS.AUTH}/update-password`, // Actualizar contraseña
  },
  authDemo: {
    split: {
